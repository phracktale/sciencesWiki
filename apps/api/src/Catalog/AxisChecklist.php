...
{
    /**
     * Question (clé `q1`…`q20`) → { section, text, help }. Ordre = ordre officiel AXIS.
     * `help` = texte d'aide OFFICIEL des auteurs (annexe explicative DC2, condensé en
     * français) : ce que la question cherche et comment y répondre. Cf.
     * docs/axis-methodologie.md.
     *
